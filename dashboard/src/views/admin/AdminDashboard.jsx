    ...
    <div className="px-2 md:px-7 py-5">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
        <div className="flex justify-between items-center bg-[#fae8e8] rounded-md p-5 gap-3">
          ...
          <div className="w-[50px] h-[50px] rounded-full bg-[#fa0305] flex justify-center items-center text-xl">
        ...
        <div className="flex justify-between items-center bg-[#fde2ff] rounded-md p-5 gap-3">
          ...
          <div className="w-[50px] h-[50px] rounded-full bg-[#760077] flex justify-center items-center text-xl">
        ...
        <div className="flex justify-between items-center bg-[#e9feea] rounded-md p-5 gap-3">
          ...
          <div className="w-[50px] h-[50px] rounded-full bg-[#038000] flex justify-center items-center text-xl">
        ...
        <div className="flex justify-between items-center bg-[#ecebff] rounded-md p-5 gap-3">
          ...
          <div className="w-[50px] h-[50px] rounded-full bg-[#0200f8] flex justify-center items-center text-xl">
